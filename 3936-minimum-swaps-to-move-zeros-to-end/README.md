<h2><a href="https://leetcode.com/problems/minimum-swaps-to-move-zeros-to-end/?envType=problem-list-v2&envId=two-pointers">4316. Minimum Swaps to Move Zeros to End</a></h2><h3>Easy</h3><hr><p>You are given an integer array <code>nums</code>.</p>
